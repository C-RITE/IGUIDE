...
#define INITIATE_COUNTDOWN	(WM_USER + 104)
#define RESET_COUNTDOWN		(WM_USER + 105)
#define GAMEPAD_UPDATE		(WM_USER + 106)
#define MOUSE_FALLBACK		(WM_USER + 107)
#define RESET_AOSACA_IP		(WM_USER + 108)
#define RESET_ICANDI_IP		(WM_USER + 109)
#define SAVE_IGUIDE_CSV		(WM_USER + 110)
#define	PATCH_TO_REGIONPANE (WM_USER + 111)
#define PATCH_SELECT		(WM_USER + 112)
#define CLEAR_REGIONPANE	(WM_USER + 113)
#define UPDATE_SELECTION	(WM_USER + 114)
