...
void CPropertyGridCombo::AddString(wstring strItem)
{
...
BOOL CPropertyGridCombo::Create(DWORD dwStyle, CRect& rc, CWnd* pParent, int nId)
{
  ...
  BOOL ret = __super::CreateEx(0, AfxRegisterWndClass(CS_HREDRAW|CS_VREDRAW), L"", dwStyle|WS_POPUP, rc, pParent->GetParent(), nId);
